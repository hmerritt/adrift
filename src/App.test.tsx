...
import { getStyle, render, renderBasic, select } from "tests";
...
test("renders app", async () => {
	...
	await waitFor(() => r.getByText(/Template react app with batteries included/i));
	const linkElement = r.getByText(/Template react app with batteries included/i);
	expect(linkElement).toBeInTheDocument();
});

// test("renders home", () => {
// 	const r = renderBasic(<IndexRoute />);
